...
router.get('/', generalRateLimit, verifyToken, sayHello); // Define a GET route for /api/hello that uses the sayHello controller
router.get('/teapot', generalRateLimit, verifyToken, iAmATeapot); // Define a GET route for /api/teapot that uses the iAmATeapot controller
router.post('/', generalRateLimit, verifyToken, postHello); // Define a POST route for /api/hello that uses the postHello controller   
